...
void PidtoPwm(float throttle, float control[3]){
	...
	motor_pwm.value[0] = motor_pwm.min + throttle + control[0] - control[1] - control[2];
	motor_pwm.value[1] = motor_pwm.min + throttle + control[0] + control[1] + control[2];
	motor_pwm.value[2] = motor_pwm.min + throttle - control[0] - control[1] + control[2];
	motor_pwm.value[3] = motor_pwm.min + throttle - control[0] + control[1] - control[2];
